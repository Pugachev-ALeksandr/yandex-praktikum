...
| [Выбор локации для скважины](choosing_a_location_for_a_well) | Построить модель для определения региона, где добыча принесёт наибольшую прибыль. Проанализировать возможную прибыль и риски техникой Bootstrap.| *pandas*, *numpy*, *sklearn*, *matplotlib*, *seaborn*, *scipy* |
