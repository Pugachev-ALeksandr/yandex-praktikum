...
| [Рекомендация тарифов](tariff recommendation) | Нужно построить модель для задачи классификации, которая выберет подходящий тариф.| *pandas*, *numpy*, *sklearn*, *matplotlib*, *seaborn* |
